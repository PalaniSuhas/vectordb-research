"""Metrics aggregation and result formatting."""
...
class MetricsAggregator:
    ...
    def aggregate_benchmark_results(
        embedding_model: str,
        vector_db: str,
        indexing_metrics: Dict[str, float],
    ...
    def _average_retrieval_metrics(
        ...
        for metrics in retrieval_metrics:
            query_embed_times.append(metrics.get("query_embedding_time_ms", 0.0))
            vector_search_times.append(metrics.get("vector_search_time_ms", 0.0))
            total_retrieval_times.append(metrics.get("total_retrieval_time_ms", 0.0))
    ...
    def _create_summary(all_results: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        for result in all_results:
            ...
            for llm_name, scores in llm_scores.items():
                quality = scores.get("avg_overall_quality", 0.0)
            ...
            avg_time = retrieval.get("avg_total_retrieval_time_ms", float('inf'))
            ...
            total_time = indexing.get("total_time_ms", float('inf'))
